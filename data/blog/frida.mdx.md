...
draft: false
summary: "This article is a write-up of the Frida challenge in the Android CTF Juicy Bar."
images: ['/static/images/canada/mountains.jpg', '/static/images/canada/toronto.jpg']
authors: ['default']
layout: PostLayout
canonicalUrl: https://ad2001.com/blog/juicy-bar-frida
---
...
![](/static/images/posts/frida/1.png)

So let's load the apk into jadx and see the decompilation for this level.

![](/static/images/posts/frida/2.png)

![](/static/images/posts/frida/3.png)
...
![](/static/images/posts/frida/4.png)
...
![](/static/images/posts/frida/5.png)

Okay now we can trigger this method in the application.

![](/static/images/posts/frida/6.png)

![](/static/images/posts/frida/7.png)

Nice we got the first flag. Let's find the second one.

## Flag Two

![](/static/images/posts/frida/8.png)
...
![](/static/images/posts/frida/9.png)

Let's see if we get the flag or not.

![](/static/images/posts/frida/10.png)

Nice we got the second flag.

## Flag Three

![](/static/images/posts/frida/11.png)
...
![](/static/images/posts/frida/12.png)

![](/static/images/posts/frida/13.png)
