...
authors: ['default']
layout: PostLayout
canonicalUrl: https://ad2001.com/blog/android-exported-broadcast-receiver
---
...
![](/static/images/posts/Broadcast/1.png)

This is a timer app let's try it out.

![](/static/images/posts/Broadcast/2.png)
...
![](/static/images/posts/Broadcast/3.png )

Oops its disabled. Let's try the normal one.

![](/static/images/posts/Broadcast/4.png )
...
![](/static/images/posts/Broadcast/5.png )
...
![](/static/images/posts/Broadcast/6.png)
...
![](/static/images/posts/Broadcast/7.png)
...
![](/static/images/posts/Broadcast/8.png)
...
![](/static/images/posts/Broadcast/9.png)

Now let's try using nc in our host.

![](/static/images/posts/Broadcast/10.png)

Woah we got the reverse shell. I know this scenario seems highly unrealistic but just wanted to showcase how we can identify exported broadcasts and how to invoke them.Now as a challenge i encourage you guys to solve this challenge by mobilehackinglab
