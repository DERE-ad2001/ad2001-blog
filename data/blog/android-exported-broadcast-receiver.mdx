...
![](/static/images/posts/Broadcast/2.png" style="zoom: 50%")
...
![](/static/images/posts/Broadcast/3.png" style="zoom: 50%")

Oops its disabled. Let's try the normal one.

![](/static/images/posts/Broadcast/4.png" style="zoom: 50%")
...
![](/static/images/posts/Broadcast/5.png" style="zoom: 50%")
...
![](/static/images/posts/Broadcast/6.png" style="zoom: 50%")
...
![](/static/images/posts/Broadcast/7.png" style="zoom: 50%")
...
![](/static/images/posts/Broadcast/8.png" style="zoom: 67%")
...
![](/static/images/posts/Broadcast/9.png" style="zoom: 50%")

Now let's try using nc in our host.

![](/static/images/posts/Broadcast/10.png" style="zoom: 67%")
