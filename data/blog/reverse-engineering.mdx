...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\1.png)

The hint says nothing much. Let's use jadx.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\2.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\3.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\4.png)

Woah we got our second flag. Let's find the third flag.

### Flag Three

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\5.png)

Let check the decompiled source code.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\6.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\7.png)

Okay we can see a lot of whitespaces. Let's copy that and paste it into the online compiler.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\8.png)

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\9.png)

Okay let's run this.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\10.png)Oops, we got an error. This is because when we copied from the output, it included unnecessary spaces in addition to the intended output. Let's fix that. For this i'm going to use sublime.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\11.png)

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\12.png)

This time we got the output "spacy." Let's try this and see if we get the flag.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\13.png)

Okay nice. Let's move on to the final flag.

### Flag Four

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\14.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\15.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\16.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\17.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\18.png)

The decryption process was successful. Now let's download the decrypted dex file and load that into jadx.

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\19.png)

![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\20.png)
...
![](D:\Blogs\Juicy Bar\Reverse Engineering\reverse-engineering\21.png)
